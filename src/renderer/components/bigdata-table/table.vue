<template>
	<div
		class="el-table el-bigdata-table"
		:class="[{
			'el-table--fit': fit,
			...
			'el-table--enable-row-transition': (store.states.data || []).length !== 0 && (store.states.data || []).length < 100}, tableSize ? `el-table--${ tableSize }` : '']"
...
<style>
.el-bigdata-table-body .el-table__row th,
.el-bigdata-table-body .el-table__row td {
	padding: 0;
}
</style>
